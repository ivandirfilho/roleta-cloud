...
| SPR-ST1 | P1 | **MERGED** | ivandirfilho-spr-st1-exec | — | BLK-G, settings, compose | PR #99 (16/08) · `SDA_V5_COVERAGE_LOCK` (vazia/17/21, por-chamada) no v5_1721 + `tools/coverage_gate_report.py` (régua E=36r−4, TOTAL n) · **ATIVADA =17 via PR #102** (auditoria achou a janela shadow JÁ cumprida: contrafactuais desde 04/08, 961 giros, sempre-17 dominou 5/5 dias, Δ+236u) · `ativado_coverage_lock = 16/08 (PR #102)` · régua de desativação: Δ<0 por 3d → flag vazia · plano: `plano_final_proposto.md` |
